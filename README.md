...
![Green tomato and kiwi](examples/green-tomato-kiwi-element-sampler.png)

### Candle, birds, lamp, and glass vessels — Watercolor Symbol Diary

![Candle, birds, lamp, and glass vessels](examples/candle-lamp-symbol-diary.png)

### Shelf objects and abstract wall art — Watercolor Symbol Diary

![Shelf objects and abstract wall art](examples/shelf-symbol-diary.png)

### Roasted squash with herb dip — Orbit + Falling Sequence

![Roasted squash with herb dip](examples/roasted-squash.png)
